\doxysection{Referência ao ficheiro C\+:/\+Users/\+Areal/\+Documents/\+Git\+Hub/\+CProjects/\+EDA/\+PFase2/lib/lib.h}
\label{lib_8h}\index{C:/Users/Areal/Documents/GitHub/CProjects/EDA/PFase2/lib/lib.h@{C:/Users/Areal/Documents/GitHub/CProjects/EDA/PFase2/lib/lib.h}}


Ficheiro Header da biblioteca \textquotesingle{}lib\textquotesingle{}.  
...
\begin{DoxyCompactList}\small\item\em Estrutura que representa um vértice em um grafo. \end{DoxyCompactList}\item 
struct \textbf{ Aresta}
\begin{DoxyCompactList}\small\item\em Estrutura que representa uma aresta num grafo. \end{DoxyCompactList}\item 
struct \textbf{ GR}
\begin{DoxyCompactList}\small\item\em Estrutura que representa um grafo. \end{DoxyCompactList}\item 
struct \textbf{ Caminho}
\begin{DoxyCompactList}\small\item\em Estrutura para armazenar caminhos com a maior soma. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Definições de tipos}
\begin{DoxyCompactItemize}
\item 
typedef struct \textbf{ Vertice} \textbf{ Vertice}
\begin{DoxyCompactList}\small\item\em Estrutura que representa um vértice em um grafo. \end{DoxyCompactList}\item 
typedef struct \textbf{ Aresta} \textbf{ Aresta}
\begin{DoxyCompactList}\small\item\em Estrutura que representa uma aresta num grafo. \end{DoxyCompactList}\item 
typedef struct \textbf{ GR} \textbf{ GR}
\begin{DoxyCompactList}\small\item\em Estrutura que representa um grafo. \end{DoxyCompactList}\item 
typedef struct \textbf{ Caminho} \textbf{ Caminho}
\begin{DoxyCompactList}\small\item\em Estrutura para armazenar caminhos com a maior soma. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Realiza uma pesquisa em profundidade (DFS) no grafo para encontrar o caminho com a maior soma. \end{DoxyCompactList}\item 
int \textbf{ soma\+\_\+pesos\+\_\+caminho} (\textbf{ GR} $\ast$grafo, int $\ast$caminho, int tamanho\+\_\+caminho)
\begin{DoxyCompactList}\small\item\em Calcula a soma dos pesos das arestas num dado caminho no grafo. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Definido no ficheiro \textbf{ lib.\+h}.



\doxysubsection{Documentação dos tipos}
\label{lib_8h_a4dfeea32aaaf68604a93805ab84f33e1} 
\index{lib.h@{lib.h}!Aresta@{Aresta}}
\index{Aresta@{Aresta}!lib.h@{lib.h}}
\doxysubsubsection{Aresta}
{\footnotesize\ttfamily typedef struct \textbf{ Aresta} \textbf{ Aresta}}



Estrutura que representa uma aresta num grafo. 

Cada aresta contém um ponteiro para um vértice de destino, um peso associado e um ponteiro para a próxima aresta na lista ligada. \label{lib_8h_a3f0cb4117cdc19cde5f8f63fdab01c20} 
\index{lib.h@{lib.h}!Caminho@{Caminho}}
\index{Caminho@{Caminho}!lib.h@{lib.h}}
\doxysubsubsection{Caminho}
{\footnotesize\ttfamily typedef struct \textbf{ Caminho} \textbf{ Caminho}}



Estrutura para armazenar caminhos com a maior soma. 

Esta estrutura é usada para armazenar uma lista ligada de caminhos no grafo. Cada caminho é representado por uma sequência de vértices e o tamanho dessa sequência. A estrutura também possui um ponteiro para o próximo caminho na lista, permitindo a criação de uma lista ligada de caminhos. \label{lib_8h_a673a73566a701f4c439ea07aafa902fd} 
\index{lib.h@{lib.h}!GR@{GR}}
\index{GR@{GR}!lib.h@{lib.h}}
\doxysubsubsection{GR}
{\footnotesize\ttfamily typedef struct \textbf{ GR} \textbf{ GR}}



Estrutura que representa um grafo. 

Um grafo é composto por um array de vértices e o número total de vértices no grafo. \label{lib_8h_a901d403606dfb55e6d42b899c05d3347} 
\index{lib.h@{lib.h}!Vertice@{Vertice}}
\index{Vertice@{Vertice}!lib.h@{lib.h}}
\doxysubsubsection{Vertice}
{\footnotesize\ttfamily typedef struct \textbf{ Vertice} \textbf{ Vertice}}
...
\label{lib_8h_a38992837f5e9da4db5b62ab02b4e0278} 
\index{lib.h@{lib.h}!add\_aresta@{add\_aresta}}
\index{add\_aresta@{add\_aresta}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_aff7d892dd0151fdd358454351233ada1} 
\index{lib.h@{lib.h}!alterar\_peso@{alterar\_peso}}
\index{alterar\_peso@{alterar\_peso}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_a0cdaf53d97ea663ac16f5cdbcca34cce} 
\index{lib.h@{lib.h}!carrega\_fich@{carrega\_fich}}
\index{carrega\_fich@{carrega\_fich}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_a3ca19fd87075df71ad6044dce237f195} 
\index{lib.h@{lib.h}!criar\_grafo@{criar\_grafo}}
\index{criar\_grafo@{criar\_grafo}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_abd5081b39f99fc214ae54edf069283a6} 
\index{lib.h@{lib.h}!dfs@{dfs}}
\index{dfs@{dfs}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_a7a7045043b24b785684c46e21cc93efe} 
\index{lib.h@{lib.h}!encontrar\_maior\_soma\_caminho@{encontrar\_maior\_soma\_caminho}}
\index{encontrar\_maior\_soma\_caminho@{encontrar\_maior\_soma\_caminho}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_a8846c49cb4bba8dd9dc88ae07c9996a0} 
\index{lib.h@{lib.h}!rem\_aresta@{rem\_aresta}}
\index{rem\_aresta@{rem\_aresta}!lib.h@{lib.h}}
...
\end{DoxyCode}
\label{lib_8h_ad2eb0fd7f69177b9371039df31137b53} 
\index{lib.h@{lib.h}!soma\_pesos\_caminho@{soma\_pesos\_caminho}}
\index{soma\_pesos\_caminho@{soma\_pesos\_caminho}!lib.h@{lib.h}}
